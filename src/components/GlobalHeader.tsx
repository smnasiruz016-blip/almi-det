// AlmiDET-branded header — own wordmark + the family sibling nav + product entry
...
// The family strip for this repo = every product except AlmiDET (its own brand
// wordmark is DET's home) + the network links. Sourced from the canonical list.
export const FAMILY_NAV = familyStrip("det");
